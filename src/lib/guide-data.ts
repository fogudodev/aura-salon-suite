...
export const categories: GuideCategory[] = [
  ...
  },
  {
    ...
    description: "Recupere clientes inativos com campanhas inteligentes via WhatsApp",
    icon: Target,
    color: "from-red-500/20 to-red-600/10",
    functions: [
      {
        id: "reativacao-engine",
        title: "Motor de Reativação",
        summary: "Sistema inteligente que identifica e reativa clientes inativos via WhatsApp.",
        description: "O Motor de Reativação analisa automaticamente o comportamento dos seus clientes usando métricas RFM (Recência, Frequência e Valor Monetário) para identificar clientes inativos ou em risco. Com base nesses dados, você pode disparar campanhas personalizadas via WhatsApp para trazê-los de volta.",
        whyImportant: "Reativar um cliente existente custa até 5x menos do que adquirir um novo. Este módulo transforma o Gende em um motor ativo de receita, gerando faturamento previsível.",
        whenToUse: "Semanalmente, para manter a base de clientes ativa e prevenir perdas. Ideal para períodos de queda no movimento.",
        problemsSolved: [
          "Clientes que param de voltar sem que você perceba",
          "Falta de visibilidade sobre quem está em risco de abandono",
          "Dificuldade em segmentar clientes para campanhas de retorno",
          "Impossibilidade de medir o ROI de ações de reativação",
        ],
        benefits: [
          "Identificação automática de clientes inativos",
          "Score inteligente (0-100) para priorização",
          "Campanhas segmentadas via WhatsApp",
          "Rastreamento automático de conversões e ROI",
          "Dashboard com métricas de receita recuperada",
        ],
        howToConfigure: [
          "Acesse o menu 'Reativação' na barra lateral",
          "Clique em 'Recalcular Scores' para a primeira análise",
          "O sistema calculará automaticamente o score de cada cliente",
        ],
        howToUse: [
          "Acesse a página de Reativação",
          "Clique em 'Recalcular Scores' para atualizar os dados",
          "Analise os clientes elegíveis e seus scores",
          "Crie uma campanha com '+ Nova Campanha de Reativação'",
          "Defina nome, mensagem e filtro de score mínimo",
          "Clique em 'Executar' para disparar as mensagens",
          "Acompanhe conversões no dashboard de métricas",
        ],
        tips: [
          "Foque nos clientes 'Warm' (score 50-79) — maior probabilidade de retorno",
          "Use variáveis como {nome} para personalizar as mensagens",
          "Recalcule os scores semanalmente",
          "Monitore a taxa de conversão para ajustar suas mensagens",
        ],
        bestPractices: [
          "Execute campanhas de reativação pelo menos 1x por semana",
          "Não envie mais de uma mensagem de reativação ao mesmo cliente em 15 dias",
          "Ofereça um incentivo (desconto, horário especial) nas mensagens",
          "Acompanhe o dashboard para medir o ROI",
        ],
        commonErrors: [
          "Não recalcular os scores regularmente",
          "Enviar mensagens genéricas sem personalização",
          "Ignorar clientes com score alto (Hot) que já deveriam ter voltado",
        ],
        importantNotes: [
          "A conversão é rastreada automaticamente: se o cliente agendar em até 15 dias após receber a mensagem, é contabilizado",
          "O WhatsApp precisa estar conectado para o envio funcionar",
          "Este módulo é exclusivo do plano Enterprise",
        ],
        expectedResult: "Sistema identificando automaticamente clientes em risco, disparando campanhas inteligentes e gerando receita previsível com ROI claro no dashboard.",
      },
    ],
  },
  {
    id: "upsell-inteligente",
    title: "Upsell Inteligente",
    description: "Aumente seu ticket médio automaticamente com sugestões inteligentes de serviços complementares via WhatsApp e página pública.",
    icon: Sparkles,
    color: "from-purple-500 to-pink-500",
    functions: [
      {
        id: "upsell-engine",
        title: "Motor de Upsell Automático",
        summary: "Sugere serviços complementares automaticamente ao agendar, aumentando o faturamento sem esforço.",
        description: "O Upsell Inteligente identifica oportunidades de venda cruzada baseado nas regras que você configura. Quando um cliente agenda um serviço, o sistema automaticamente oferece serviços complementares via WhatsApp ou na página de agendamento online.",
        whyImportant: "Salões que utilizam upsell automático aumentam em média 15-30% o ticket médio. É como ter uma recepcionista que nunca esquece de oferecer serviços complementares.",
        whenToUse: "Sempre que você quiser aumentar a receita por atendimento sem precisar de mais clientes. Ideal para serviços que se complementam naturalmente (corte + escova, unha + esmaltação, etc).",
        problemsSolved: [
          "Recepcionista esquece de oferecer serviços complementares",
          "Ticket médio estagnado",
          "Oportunidades de venda perdidas em cada atendimento",
          "Falta de estratégia para cross-sell",
        ],
        benefits: [
          "Aumento automático do ticket médio",
          "Mensagens personalizadas via WhatsApp",
          "Sugestões na página de agendamento online",
          "Dashboard com métricas de conversão e receita",
          "Descontos promocionais automáticos",
        ],
        howToConfigure: [
          "Acesse Upsell Inteligente > Configuração no menu lateral",
          "Clique em '+ Adicionar regra'",
          "Selecione o serviço principal (ex: Corte Feminino)",
          "Selecione o serviço a sugerir (ex: Hidratação)",
          "Defina o desconto (%), preço promocional e timing de envio",
          "Personalize o template da mensagem WhatsApp com variáveis: {nome}, {servico}, {upsell}, {desconto}",
          "Salve a regra e ative-a",
        ],
        howToUse: [
          "Após configurar as regras, o sistema funciona automaticamente",
          "Quando um cliente agenda um serviço com regra ativa, o WhatsApp envia a oferta",
          "Na página pública, as sugestões aparecem durante o agendamento",
          "Acompanhe o desempenho em Upsell > Dashboard",
          "A conversão é rastreada automaticamente quando o cliente adiciona o serviço",
        ],
        tips: [
          "Comece com 2-3 regras para os serviços mais populares",
          "Ofereça descontos de 10-20% para aumentar a conversão",
          "Use mensagens naturais que soem como uma recepcionista",
          "Acompanhe o dashboard semanalmente para otimizar as regras",
        ],
        bestPractices: [
          "Limite a 2 sugestões por agendamento para não parecer agressivo",
          "Escolha serviços que realmente se complementam",
          "Ajuste os descontos com base na taxa de conversão",
          "Teste diferentes templates de mensagem para ver qual converte mais",
        ],
        commonErrors: [
          "Criar muitas regras sem foco nos serviços principais",
          "Mensagens genéricas que não engajam o cliente",
          "Não acompanhar as métricas do dashboard",
          "Descontos muito baixos que não motivam a compra",
        ],
        importantNotes: [
          "O WhatsApp precisa estar conectado para envio automático",
          "A conversão é rastreada automaticamente quando o cliente adiciona o serviço sugerido",
          "Se não houver regras configuradas, a IA sugere automaticamente na página pública",
          "Este módulo é exclusivo do plano Enterprise",
        ],
        expectedResult: "Aumento consistente do ticket médio com sugestões automáticas, sem esforço manual. Dashboard mostrando ROI claro de cada regra de upsell.",
      },
    ],
  },
];
